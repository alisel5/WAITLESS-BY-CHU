...
from routers import tickets_enhanced, ai_predictions
...
# Include AI predictions and analytics
app.include_router(ai_predictions.router, prefix="/api/ai", tags=["AI Predictions & Analytics"])
