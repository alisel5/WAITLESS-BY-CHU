...
from auth import get_current_active_user, get_admin_or_staff_user, get_current_user_optional
...
async def patient_chat(
    ...
    current_user: Optional[User] = Depends(get_current_user_optional)  # Allow anonymous access for patients
):
    """
