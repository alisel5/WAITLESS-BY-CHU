...
async def run_queue_test():
    ...
    async with QueueTester() as tester:
        ...
        await tester.login_user("admin@example.com", "admin123")
        
        # Step 2: Login test users A and B (create if needed)
        print("\n📋 Step 2: Login test users")
        await tester.login_user("usera@test.com", "password123")
        await tester.login_user("userb@test.com", "password123")
